...
const Notification = ({ type, message, children }) => {
    ...
    return (React__default["default"].createElement(StyledNotification, { type: type, className: `tui-notification tui-${type}` },
        React__default["default"].createElement(Icon$1, { type: type, className: "tui-notification-icon" }, renderIcon()),
...
const Button = ({ children, onClick, className = '', loading = false, icon, disabled = false, testId = 'button', ...props }) => {
    ...
    const renderIcon = () => {
        ...
        return React__default["default"].createElement(Icon, { className: "tui-button-icon" }, React.cloneElement(icon, { size: 14 }));
    };
    const getClass = () => {
...
const ListItem = ({ children, title = '' }) => {
    return (React__default["default"].createElement("div", { className: "tui-listItem" },
        React__default["default"].createElement(StyledListTitle, { className: "tui-title" }, title),
        children));
};
...
const Modal = ({ children, onClose, onOpen, open }) => {
    ...
    return (React__default["default"].createElement(StyledModal, { closing: isClosing, className: getClasses },
        renderCloseButton(),
        React__default["default"].createElement("div", { className: "tui-modal-content" }, children)));
};
...
`;
const PopupBlocker = styled__default["default"].div `
  position: absolute;
  z-index: 800;
  height: 100vh;
  width: 100vw;
...
const Popup = ({ title = '', open = false, onClose, onOpen = () => { }, name, children, buttons, width = 'auto', fullscreen = false, closeText = 'Close', }) => {
    ...
    const renderButtons = () => {
        ...
        return (React__default["default"].createElement(ButtonGroup, { className: "tui-popup-buttons" }, buttons.map((button, i) => (React__default["default"].createElement("div", { key: i }, button)))));
    };
    const renderPopup = () => {
        if (!isOpen) {
            return null;
        ...
        return (React__default["default"].createElement(StyledPopup, { className: getClasses(), "$fullscreen": fullscreen, open: isOpen },
            React__default["default"].createElement(Content$1, { className: "tui-popup-content", style: { width: width } },
                ...
                children,
                React__default["default"].createElement(Footer, { className: "tui-popup-footer" },
                    renderButtons(),
                    React__default["default"].createElement("div", null))),
            React__default["default"].createElement(PopupBlocker, { className: "tui-popup-blocker", onClick: () => closePopup() })));
    };
    return renderPopup();
};
